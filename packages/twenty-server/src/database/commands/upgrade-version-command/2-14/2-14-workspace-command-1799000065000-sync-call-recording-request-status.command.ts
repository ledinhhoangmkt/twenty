...
import {
  remapRecordPageUniversalIdentifiersToPre227,
  toPre227RecordPageUniversalIdentifier,
} from 'src/database/commands/upgrade-version-command/2-10/utils/remap-record-page-universal-identifiers-to-pre-2-27.util';
...
export class SyncCallRecordingRequestStatusCommand extends ProvisionedWorkspaceCommandRunner {
  constructor(
  ...
  override async runOnWorkspace({
    ...
    // This command predates the 2-27 record-page reconcile: workspace rows
